...
APP_TITLE		:= Legendary Chest 3D
APP_DESCRIPTION 	:= Legendary Chest 3D
APP_AUTHOR		:= Sleeping Cat Studios
...
LIBS	:=  -lSDLmain -lSDL_image -lSDL_gfx  -lSDL_ttf -lSDL_mixer -lSDL -lvorbisidec -logg  -lcitro3d -lcitro2d -lctru -lm -lpng -lpng16 -lz -lmikmod -lmad -ljpeg -lfreetype -lbz2 
